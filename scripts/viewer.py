...
class ViewerClass:
    ...
    def __init__(self, sim_instance=None, training_mode=False):
        ...
        self.disable_action_input = False
    ...
    def get_simulation_data(self):
        if not self.simulation_ready:
            ...
            if self.ready_check_attempts < 3:
                return None
            else:
    ...
    def draw_inbound_clock(self, data):
        ...
        box_vertical_offset_from_top_px = 20
    ...
    def draw_simulation_data(self, data):
        ...
        if ('agent_pos' in data and data['agent_pos'] is not None and
            ...
            for i, pos in enumerate(positions):
                ...
                if i == self.active_agent_idx:
                    pygame.draw.polygon(self.screen, (0, 255, 255), agent_points, 3)
                else:
        ...
        if 'basketball_pos' in data and data['basketball_pos'] is not None:
            ...
            basketball_positions = data['basketball_pos'][world_idx]
        ...
        if 'hoop_pos' in data:
            ...
            hoop_positions = data['hoop_pos'][world_idx]
