...
namespace madBasketball {
    ...
    // ======================================== Rendering & Scaling ========================================
    constexpr float PIXELS_PER_METER = 110.f; // for visualization scaling
    ...
    constexpr float START_POS_STDDEV = 4.f;
    constexpr float DEFAULT_SPEED = 3.f;
    constexpr float DEFENDER_SLOWDOWN = 0.2f; // The speed of the defender is 1 - DEFENDER_SLOWDOWN
    constexpr float DEFENDER_REACTION = 4.5f;
    constexpr float DEFENDER_SPAWN_RADIUS = 2.f; // At what radius to spawn the defender from offender
