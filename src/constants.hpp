...
namespace madBasketball {
    ...
    constexpr float TIME_PER_PERIOD = 6.f; // (in seconds)
    ...
    constexpr float START_POS_STDDEV = 1.f; 
    constexpr float DEFENDER_SLOWDOWN = .1f; // The speed of the defender is 1 - DEFENDER_SLOWDOWN
